# Chameleon Adapt — Design Quality Reference

> Loaded during Phase 3 (COLOR) when adapting UI components. This prevents "AI-looking" output.
> The Elephant has a copy of this reference too. Both builders must follow it.
