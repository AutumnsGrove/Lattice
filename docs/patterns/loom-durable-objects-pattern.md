...
The Loom architecture integrates with the [Threshold pattern](/knowledge/patterns/threshold-pattern) for rate limiting and abuse prevention. This provides enterprise-grade protection against spam, DDoS, and resource abuse.
