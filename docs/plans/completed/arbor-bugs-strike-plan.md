...
**File:** `packages/engine/src/routes/+layout.server.ts`
...
**File:** `packages/engine/src/routes/admin/+layout.svelte`
...
**Files:**
- `packages/engine/src/routes/admin/+layout.svelte` (sidebar header)
- `packages/engine/src/routes/+layout.svelte` (root layout)
- `packages/engine/src/lib/styles/tokens.css` (CSS variable bridge)
...
| File | Strikes |
|------|---------|
| `packages/engine/src/routes/+layout.server.ts` | #1 |
| `packages/engine/src/routes/+layout.svelte` | #2, #4 |
| `packages/engine/src/routes/admin/+layout.svelte` | #3, #4 |
| `packages/engine/src/lib/styles/tokens.css` | #4 |
