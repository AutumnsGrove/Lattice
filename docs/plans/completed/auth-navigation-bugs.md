...
`apps/landing/src/routes/+page.server.ts` returns `groveUrl: null` when:
...
**File:** `apps/landing/src/routes/+page.server.ts`
...
**File:** `libs/engine/src/routes/admin/+layout.server.ts`
...
| File                                                 | Change                                                | Issue |
| ---------------------------------------------------- | ----------------------------------------------------- | ----- |
| `apps/landing/src/routes/+page.server.ts`            | Add fallback for missing groveUrl                     | #865  |
| `libs/engine/src/routes/admin/+layout.server.ts` | Add debug logging, then fix based on findings         | #866  |
| `libs/engine/src/hooks.server.ts`                | (Possibly) Handle missing email in SessionDO response | #866  |
...
1. Read `apps/landing/src/routes/+page.server.ts`
...
1. Add debug logging to `libs/engine/src/routes/admin/+layout.server.ts`
