...
- `libs/engine/src/lib/lumen/types.ts` — Added `tenantApiKey` to `LumenRequestOptions`
- `libs/engine/src/lib/lumen/client.ts` — Pass tenant key to provider when present
- `libs/engine/src/lib/lumen/providers/openrouter.ts` — Accept optional key override
- `libs/engine/src/lib/lumen/providers/types.ts` — Added `apiKeyOverride` to `LumenInferenceOptions`
- `libs/engine/src/lib/lumen/router.ts` — Thread key override through fallback chain
...
- `libs/engine/src/lib/lumen/providers/cloudflare-ai.ts` — Vision model support with multimodal content
- `libs/engine/src/lib/lumen/config.ts` — Added CF_LLAMA4_SCOUT model, updated image task fallback chain
...
- `libs/engine/src/lib/lumen/router.ts` — `skipFallbacks` logic when model override is present
...
- `libs/engine/src/routes/api/grove/wisp/fireside/+server.ts`
...
- `libs/engine/src/routes/api/curios/timeline/generate/+server.ts`
- `libs/engine/src/lib/curios/timeline/providers/openrouter.ts`
- `libs/engine/src/lib/curios/timeline/index.ts`
- `libs/engine/src/lib/index.ts`
...
- `libs/engine/src/lib/server/petal/lumen-classify.ts`
...
- `libs/engine/src/lib/thorn/index.ts` — Public exports
- `libs/engine/src/lib/thorn/config.ts` — Category/threshold config
- `libs/engine/src/lib/thorn/moderate.ts` — Core moderation function
- `libs/engine/src/lib/thorn/types.ts` — Type definitions

**Package export added:**

- `./thorn` in `libs/engine/package.json`
...
- Provider/model sections from `libs/engine/src/lib/config/wisp.ts`
- `callInference()` and provider logic from `libs/engine/src/lib/server/inference-client.ts`
