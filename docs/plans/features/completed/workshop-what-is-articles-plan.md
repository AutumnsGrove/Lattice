...
When an article is created, update the corresponding tool in `apps/landing/src/routes/workshop/+page.svelte`:
...
- `apps/landing/src/routes/workshop/+page.svelte` — Workshop tool definitions
- `apps/landing/src/lib/server/docs-scanner.ts` — Auto-discovery system
