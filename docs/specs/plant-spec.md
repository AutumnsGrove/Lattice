...
```
    ...
    ┌─────────────────────────────────────────────────────────────────────────┐
    │                                                                         │
    │   SIGNUP         VERIFY         PLAN          PAY          TOUR         │
    │     │              │             │             │             │          │
    │     ▼              ▼             ▼             ▼             ▼          │
    │   ╭────╮        ╭────╮        ╭────╮        ╭────╮        ╭────╮        │
    │   │ 📝 │   →    │  ✉️ │   →    │ 🌱 │   →    │ 💳 │   →    │  🎓 │        │
    │   │    │        │    │        │    │        │    │        │    │        │
    │   │name│        │link│        │tier│        │pay │        │walk│        │
    │   │user│        │click│       │pick│        │ment│        │thru│        │
    │   ╰────╯        ╰────╯        ╰────╯        ╰────╯        ╰────╯        │
    │                                                                         │
    │   ──────────────────────────────────────────────────────────────        │
    │                                                                         │
...
│  🌿                                                             │
│                                                                 │
│               Check your email, Autumn.                         │
│                                                                 │
│  We sent a verification link to autumn@example.com              │
...
│                                                                 │
│  [← Back to signup]                     [Continue anyway? →]    │
└─────────────────────────────────────────────────────────────────┘
```

**Step 2b: Verification Confirmed**
...
│               Choose Your Plan                                  │
│                                                                 │
│  [Monthly ○]  [Yearly ●]  Save 15% annually                     │
│                                                                 │
│  ┌──────────────┐ ┌──────────────┐ ┌──────────────┐             │
│  │  🌱 Seedling │ │  🌿 Sapling   │ │  🌳 Oak      │             │
│  │    $8/mo     │ │   $12/mo     │ │   $25/mo     │             │
│  │              │ │   POPULAR    │ │   BEST VALUE │             │
│  │  • 50 posts  │ │ • 250 posts  │ │ • Unlimited  │             │
│  │  • 1 GB      │ │ • 5 GB       │ │ • 20 GB      │             │
│  │  • 3 themes  │ │ • 10 themes  │ │ • Customizer │             │
│  │              │ │              │ │ • Community  │             │
...
│     └───────────────────────────┘                               │
│                                                                 │
│  All plans: Meadow reader, RSS feed, no ads, data export        │
│                                                                 │
│  [View full comparison →]                                       │
└─────────────────────────────────────────────────────────────────┘
```

**Step 3b: Plan Comparison Table (if "View full comparison" clicked)**
...
│  ├────────────────┼──────────┼──────────┼────────────┼──────────┤        │
│  │ Monthly Price  │ $8       │ $12      │ $25        │ $35      │        │
│  │ Yearly Price   │ $72/yr   │ $108/yr  │ $225/yr    │ $315/yr  │        │
│  │ Posts          │ 50       │ 250      │ Unlimited  │ Unlimited│        │
│  │ Storage        │ 1 GB     │ 5 GB     │ 20 GB      │ 100 GB   │        │
│  │ Themes         │ 3        │ 10       │ 10         │ 10       │        │
│  │ Customizer     │ —        │ —        │ Full       │ Full     │        │
│  │ Custom Fonts   │ —        │ —        │ —          │ ✓ (10)   │        │
│  │ Custom Domain  │ —        │ —        │ —          │ ✓        │        │
...
### 5.3b Tour UI — Three Example Stops
...
│  │ 🌿 Post Editor                                │   │
│  │                                               │   │
│  │ Write in markdown with live preview on the    │   │
│  │ right. Add images, format text, code blocks.  │   │
...
└──────────────────────────────────────────────────────┘
           ...
           Floating above the Post Editor ↓
...
│  │ 🌿 Vines in the Margin                        │   │
│  │                                               │   │
│  │ Vines let you link to related posts on the    │   │
│  │ right. Use them to connect your ideas and     │   │
│  │ build webs of thought.                        │   │
│  │                                               │   │
│  │ Step 3/9                                      │   │
│  └───────────────────────────────────────────────┘   │
│                    ▲                                 │
...
└──────────────────────────────────────────────────────┘
           ...
           Floating above the Vines sidebar ↓
...
│  │ 🌿 Your Dashboard                             │   │
│  │                                               │   │
│  │ This is where you manage everything: write    │   │
│  │ posts, edit themes, adjust settings. Your     │   │
│  │ command center.                               │   │
│  │                                               │   │
│  │ Step 4/9                                      │   │
│  └───────────────────────────────────────────────┘   │
...
│                    You're all set!                              │
│                                                                 │
│              Your blog is ready to come alive.                  │
│                                                                 │
│  ┌─────────────────────────────────────────────────────────┐    │
│  │ 9/9 ✓ Tour complete                                     │    │
│  │                                                         │    │
