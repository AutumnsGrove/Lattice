...
```
    ○ Planned          ◐ In Progress       ✓ Complete         ◇ Deferred
    ┄┄┄┄┄┄┄┄┄          ┄┄┄┄┄┄┄┄┄┄┄┄┄       ┄┄┄┄┄┄┄┄┄┄        ┄┄┄┄┄┄┄┄┄┄
    ...
    waiting             walking             arrived            resting
    on the path         the path            safely             for now
```
...
```
┌─────────────────────────────────────────────────────────────────────┐
│  Edit Trail: Building My Garden Blog                        [Save]  │
├─────────────────────────────────────────────────────────────────────┤
│                                                                     │
│   ┌─ FOUNDATION ─────────────────────────────────────────────────┐  │
│   │  ≡  ✓  Set up Grove blog                              [···]  │  │
...
│                                                                     │
│   ┌─ CORE CONTENT ───────────────────────────────────────────────┐  │
│   │  ≡  ✓  Seed starting guide               Jan 2026    [···]  │  │
│   │  ≡  ◐  Composting series                 Feb 2026    [···]  │  │
│   │  ≡  ○  Container gardening basics        Mar 2026    [···]  │  │
│   │  ≡  ○  Seasonal planting calendar        Spring      [···]  │  │
│   │  + Add waypoint                                               │  │
│   └───────────────────────────────────────────────────────────────┘  │
│                                                                     │
│   + Add new phase                                                   │
│                                                                     │
│   ─────────────────────────────────────────────────────────────     │
│   Drag ≡ to reorder  ·  Click status to cycle  ·  [···] for more   │
│                                                                     │
└─────────────────────────────────────────────────────────────────────┘
```
...
```
┌─────────────────────────────────────────────────────────────────────┐
│  🌲 oak's trail                                    oak.grove.place   │
├─────────────────────────────────────────────────────────────────────┤
│                                                                     │
│    Building My Garden Blog                          ████████░░ 80%  │
│    ─────────────────────────────────────────                        │
│                                                                     │
│    A winding path through the seasons of creation.                  │
│                                                                     │
│    ════════════════════════════════════════════════════════════     │
│                                                                     │
│    FOUNDATION                            ✓ Complete                 │
...
│                                                                     │
│      ✓  Seed starting guide                          Jan 2026      │
│      ◐  Composting series (3 parts)                  Feb 2026      │
│      ○  Container gardening basics                   Mar 2026      │
│      ○  Seasonal planting calendar                   Spring        │
│                                                                     │
│    ════════════════════════════════════════════════════════════     │
│                                                                     │
│    FUTURE DREAMS                         ○ Planned                  │
│    ┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄                            │
│                                                                     │
│      ○  Video tutorials                                             │
│      ○  Reader Q&A series                                           │
│      ◇  Podcast exploration                          deferred       │
│                                                                     │
│    ─────────────────────────────────────────                        │
│    The path becomes clear by walking it.                            │
│                                                                     │
...
```
  The trail winds through the seasons:
