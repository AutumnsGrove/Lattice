---
title: "Lattice — Technical Specification (ARCHIVED)"
description: "Deprecated specification for the original Lattice package, now superseded by lattice-spec.md."
category: specs
...
>
> As of v1, the package is being renamed from `@autumnsgrove/lattice` to `@autumnsgrove/lattice`.
...
> _The engine that powers growth_

---

# Lattice — Technical Specification (ARCHIVED)

The core technical specification for Lattice, Grove's Cloudflare-native blog engine published as an npm package. Documents the architecture, deployment model, and single-tenant design where each customer gets dedicated D1/KV/R2 resources.
...
Lattice uses **magic code authentication** via Resend for passwordless login. This provides a secure, user-friendly experience without password management overhead.
