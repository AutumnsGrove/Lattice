...
> **Purpose**: Track screenshots, photos, and visual content needed for marketing pages, galleries, and carousels across the Grove platform.
>
> **Note**: Helpdesk article screenshots are tracked separately in their own issue.
...
- [ ] **Writing in progress** - Mid-composition with markdown preview
- [ ] **Mobile editor** - Responsive view on phone
...
- [ ] **Single post view** - A beautiful article with proper typography
- [ ] **Mobile blog view** - Responsive reading experience
- [ ] **Different seasons** - Same blog in spring/summer/autumn/winter themes
...
- [ ] **Lightbox open** - Full-screen image viewing
...
- [ ] **Posts management** - List of drafts and published posts
...
- [ ] **Blocked bots visualization** - If we have any UI showing protection
- [ ] **robots.txt comparison** - Before/after or Grove vs others (could be graphic, not screenshot)
...
- [ ] **Grove vs Big Tech** - Visual comparison (not aggressive, just contrast)
- [ ] **Community visualization** - Forest of groves/trees representing users
...
- [ ] **Welcome complete** - Success state
...
- `docs/internal/decks/Grove-Hero-Carousel.pptx` - Source for current carousel slides
- `docs/internal/decks/Grove-Overview.pptx` - May contain reusable visuals
- `docs/marketing/promo-video-concept.md` - Video storyboard (could extract stills)
- `docs/marketing/video-concept-shade-demo.md` - Shade demo visuals
