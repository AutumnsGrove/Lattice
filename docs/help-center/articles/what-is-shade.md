---
title: What is Shade?
description: Grove's layered defense system protecting your content from AI crawlers and scrapers
category: help
...
Somewhere along the way, the internet changed. What was once a place for personal expression became a resource to be mined. Tech giants scrape websites to train AI models, often without permission, attribution, or compensation. Your blog posts become training data. Your voice gets absorbed into a statistical average.
...
**Layer 2: Firewall rules** — Custom rules catch scrapers that fake their identity or behave suspiciously.

**Layer 3: Rate limiting** — Bulk scraping patterns get detected and throttled. Real humans browsing at normal speed pass through unaffected.

**Layer 4: Behavioral analysis** — AI Labyrinth wastes scraper resources with meaningless responses while legitimate visitors get the real content.

**Layer 5: Verification challenges** — When behavior is ambiguous, Turnstile (Cloudflare's privacy-friendly CAPTCHA alternative) confirms the visitor is human.
...
- [How Grove protects your content](/knowledge/help/how-grove-protects-your-content)
- [Understanding your privacy](/knowledge/help/understanding-your-privacy)
- [What is Solarpunk?](/knowledge/help/what-is-solarpunk) — The values behind these choices
- [Shade Specification](/knowledge/specs/shade-spec)
- [Grove Workshop → Shade](/workshop#tool-shade)

---

*Shade is the cool relief beneath the canopy—protection from the harsh glare of exposure. In a forest full of harvesters, this grove stays shaded.*
