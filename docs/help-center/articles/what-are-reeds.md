...
Below each of your posts, readers see a simple form:

**Private replies** — Goes directly to you. No one else ever sees it. No moderation queue, no approval needed. Just a message from reader to writer.

Use cases:
- "Thanks for writing this"
- "I think there's a typo in paragraph 3"
- Personal responses they don't want public

**Public comments** — Submitted for your approval. Once you approve, it appears on the post for everyone to see. You control what becomes part of the public conversation.

Use cases:
- Adding to the discussion
- Asking questions others might have
...
**More genuine engagement.** Private replies encourage responses from people who wouldn't comment publicly.

**You control the public conversation.** Nothing appears on your posts without your approval.
