...
- **Image Uploads Enabled (Legacy)** — Legacy master gate for image uploads (superseded by image_uploads + uploads_suspended)
- **Photo Gallery (Deprecated)** *(deprecated)* — DEPRECATED: Disabled by migration 055. Superseded by image_uploads + uploads_suspended
