...
You must be at least **18 years of age** to use the Service. By using Grove, you represent and warrant that you meet this age requirement.

---

## 3. Description of Service

Grove is a multi-tenant blogging platform that provides:
...
**Privacy Controls (Evergreen tier only):** Users on the Evergreen subscription tier may choose to require login for blog access. When enabled, **any authenticated Grove user (including free accounts) can view the blog**—this is not granular access control. You cannot restrict access to specific individuals or groups through this feature. If you need granular permissions (e.g., allowlists, paid subscriber-only access, or team-specific viewing), contact us about custom enterprise plans.
...
Grove offers the following subscription plans:
...
- You will receive a payment reminder email 5 days before your billing date (day 25 of your billing cycle)
- If payment fails, you will receive daily reminder emails during the grace period

### 5.4 Failed Payments

- A **7-day grace period** is provided for failed payments
- During the grace period, you will receive daily reminder emails
- If payment is not received within the grace period, your account will be suspended
- Your data will be archived for **30 days** after suspension to allow you to resume your plan
...
- **After 14 days:** Pro-rated refund for unused portion of current billing period
...
You retain all ownership rights to the content you create and publish on Grove ("User Content"). We do not claim ownership of your content.

### 7.2 License to Grove
...
### 9.1 Grove's Intellectual Property
...
The Grove platform code is available under the [GNU Affero General Public License v3.0 (AGPL-3.0)](https://github.com/AutumnsGrove/Lattice/blob/main/LICENSE). This allows you to view and learn from the code while ensuring that any modifications to the platform remain open source.
...
You agree to indemnify and hold us harmless from any claims, damages, losses, or expenses (including reasonable attorney's fees) arising from:
...
We strive to maintain **99.9% uptime** for the Service, consistent with our infrastructure provider (Cloudflare). However, we do not guarantee uninterrupted access.
...
- Fail to pay for the Service after the grace period
...
- Provisions that should survive termination (such as limitations of liability) will continue to apply
...
These Terms, together with our Privacy Policy, Acceptable Use Policy, DMCA Policy, and Refund Policy, constitute the entire agreement between you and us regarding the Service.
...
_By using Grove, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service._
