...
export type TierIcon = "user" | "sprout" | "tree-deciduous" | "trees" | "crown" | "footprints";
...
export interface TierDisplay {
	...
	/** Standard (non-grove) name for pricing display */
	standardName?: string;
	/** Standard feature strings for pricing display */
