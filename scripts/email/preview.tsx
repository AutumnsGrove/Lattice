...
// Sequences
import { WelcomeEmail } from "../../packages/engine/src/lib/email/sequences/WelcomeEmail";
import { Day1Email } from "../../packages/engine/src/lib/email/sequences/Day1Email";
import { Day7Email } from "../../packages/engine/src/lib/email/sequences/Day7Email";
import { Day14Email } from "../../packages/engine/src/lib/email/sequences/Day14Email";
import { Day30Email } from "../../packages/engine/src/lib/email/sequences/Day30Email";

// Lifecycle
import { RenewalThankYou } from "../../packages/engine/src/lib/email/lifecycle/RenewalThankYou";
import { GentleNudge } from "../../packages/engine/src/lib/email/lifecycle/GentleNudge";
...
const TEMPLATES: TemplateEntry[] = [
    ...
    element: React.createElement(PatchNotesEmail, {
      ...
      notes: [
        ...
        },
        {
          ...
          description:
            "Preview email templates before sending. See exactly what your readers see.",
          tag: "new" as const,
        },
        {
          icon: "🛡️",
        ...
        },
        {
          ...
          description:
            "Fixed an issue where timeline entries could overlap on mobile viewports.",
          tag: "fixed" as const,
        },
      ],
    }),
  },
  {
    ...
    element: React.createElement(AnnouncementEmail, {
      ...
      closing:
        "More updates coming soon. As always, just reply if you want to talk.",
    }),
  },
