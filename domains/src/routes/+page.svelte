...
<main class="min-h-screen flex flex-col">
	...
	<section class="flex-1 flex flex-col items-center justify-center px-6 py-16">
		...
		<div class="flex items-center gap-4 mb-8">
			...
			<svg class="w-4 h-4 text-domain-400 dark:text-domain-600" viewBox="0 0 20 20" fill="currentColor">
		...
		<!-- Description -->
		<div class="glass-tint max-w-xl text-center mb-12 p-6 rounded-xl">
		...
		<div class="grid md:grid-cols-3 gap-6 max-w-3xl mb-12">
			...
			<div class="glass-card glass-card-hover p-6 text-center">
				<div class="w-12 h-12 mx-auto mb-4 text-amber-600 dark:text-amber-400">
					<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" class="w-full h-full">
	...
	<footer class="py-8 text-center">
		<div class="flex flex-wrap items-center justify-center gap-x-4 gap-y-2 text-sm font-sans text-bark/50 dark:text-neutral-500 mb-4">
			...
			<a href="https://grove.place/vision" class="hover:text-domain-600 dark:hover:text-domain-400 transition-colors">
				Vision
			</a>
			<span class="text-domain-300 dark:text-domain-700">·</span>
			<a href="https://grove.place/pricing" class="hover:text-domain-600 dark:hover:text-domain-400 transition-colors">
				Pricing
			</a>
			<span class="text-domain-300 dark:text-domain-700">·</span>
			<a href="https://grove.place/legal" class="hover:text-domain-600 dark:hover:text-domain-400 transition-colors">
				Legal
			</a>
		</div>
