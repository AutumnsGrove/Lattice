<script lang="ts">
	 ...
	 */
	import { rollDice, DICE_FACES, type DiceRollerConfig, type DiceType } from '$lib/curios/artifacts';
	...
	const shapePath = $derived.by(() => {
		switch (diceType) {
			case 'd4': return 'M25 5 L48 42 L2 42Z';
			case 'd8': return 'M25 2 L48 25 L25 48 L2 25Z';
			case 'd12': return 'M25 2 L44 12 L48 32 L36 47 L14 47 L2 32 L6 12Z';
			case 'd20': return 'M25 1 L46 14 L46 36 L25 49 L4 36 L4 14Z';
			default: return 'M5 5 H45 V45 H5Z'; // d6
		}
	});
</script>
...
<style>
	...
	@media (prefers-reduced-motion: reduce) {
		.rolling .dice-body { animation: none; }
	}
</style>
