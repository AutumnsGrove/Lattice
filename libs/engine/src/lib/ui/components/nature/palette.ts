...
/** The four regular seasons (midnight is a special easter egg mode) */
 ...
 */
export function getCherryColors(
  season: Season = "spring",
):
  | typeof cherryBlossoms
  | typeof autumnReds
  | typeof cherryBlossomsPeak
  | null {
  if (season === "spring") {
 ...
 */
export function pickRandom<T extends Record<string, string>>(
  palette: T,
): string {
