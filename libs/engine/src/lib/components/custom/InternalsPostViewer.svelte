<script>
	import GlassCard from "../../ui/components/ui/GlassCard.svelte";

	/**
	 * Featured garden post card with Glass treatment.
...
<GlassCard variant="default" as="article" hoverable class="post-viewer">
	{#if caption}
