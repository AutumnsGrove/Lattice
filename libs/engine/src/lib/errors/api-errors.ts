...
export const API_ERRORS = {
	...
	PAYMENT_PROVIDER_NOT_CONFIGURED: {
		...
		adminMessage: "Payment provider (Stripe) not configured.",
	},

	AI_SERVICE_NOT_CONFIGURED: {
		code: "GROVE-API-005",
		category: "bug" as const,
		userMessage: "This feature isn't available right now. Please try again later.",
	...
	INVALID_ORIGIN: {
		...
		adminMessage: "CSRF origin validation failed. Origin header doesn't match expected host.",
	},

	INVALID_CSRF_TOKEN: {
		code: "GROVE-API-022",
		category: "user" as const,
		userMessage: "Request failed for security reasons. Please refresh the page and try again.",
	...
	TENANT_CONTEXT_REQUIRED: {
		...
		adminMessage: "Tenant context (locals.tenantId or context.tenant) is missing.",
	},
	...
	MISSING_REQUIRED_FIELDS: {
		code: "GROVE-API-041",
		category: "user" as const,
		userMessage: "Some required fields are missing. Please fill them in and try again.",
	...
	VALIDATION_FAILED: {
		code: "GROVE-API-042",
		category: "user" as const,
		userMessage: "Some of the information provided isn't quite right. Please check and try again.",
		adminMessage: "Input validation failed (format, length, or value constraint).",
	},
	...
	SLUG_CONFLICT: {
		code: "GROVE-API-044",
		category: "user" as const,
		userMessage: "That URL path is already in use. Please choose a different one.",
	...
	CONTENT_TOO_LARGE: {
		code: "GROVE-API-045",
		category: "user" as const,
		userMessage: "The content is too large. Please reduce the size and try again.",
	...
	INVALID_FILE: {
		code: "GROVE-API-046",
		category: "user" as const,
		userMessage: "This file type isn't supported or the file appears to be corrupted.",
		adminMessage: "File validation failed (type, extension, signature, or dimensions).",
	},
	...
	EXPORT_TOO_LARGE: {
		...
		adminMessage: "Export exceeds maximum size limits (posts, media, or pages count).",
	},
	...
	EXPORT_IN_PROGRESS: {
		...
		adminMessage: "Concurrent export rejected — an export is already in-progress for this tenant.",
	},
	...
	COMMENTS_DISABLED: {
		...
		adminMessage: "Comment submission attempted on post with comments disabled.",
	},
	...
	COMMENT_EDIT_WINDOW_CLOSED: {
		code: "GROVE-API-052",
		category: "user" as const,
		userMessage: "The edit window has closed. Comments can only be edited within 15 minutes.",
	...
	POST_LIMIT_REACHED: {
		code: "GROVE-API-054",
		category: "user" as const,
		userMessage: "You've filled your garden. Upgrade your plan to keep writing.",
		adminMessage: "Published post count has reached tier limit. Upgrade required to create more.",
	},

	DRAFT_LIMIT_REACHED: {
		code: "GROVE-API-055",
		category: "user" as const,
		userMessage: "You've reached your draft limit. Publish or delete some drafts to make room.",
	...
	BLOG_NOT_AVAILABLE: {
		...
		adminMessage: "User attempted blog operation but tier does not include blog access.",
	},

	FREE_ACCOUNT_IP_LIMIT: {
		code: "GROVE-API-057",
		category: "user" as const,
		userMessage: "Too many free accounts have been created recently. Please try again later.",
		adminMessage: "IP-based free account creation limit exceeded (3 per IP per 30 days).",
	},
	...
	RATE_LIMITED: {
		code: "GROVE-API-060",
		category: "user" as const,
		userMessage: "You're moving faster than we can keep up! Please wait a moment.",
	...
	USAGE_LIMIT_REACHED: {
		code: "GROVE-API-061",
		category: "user" as const,
		userMessage: "You've reached your usage limit. It resets at the start of the month.",
		adminMessage: "Monthly or daily usage cap reached (AI, transcription, etc.).",
	},
	...
	UPSTREAM_ERROR: {
		code: "GROVE-API-082",
		category: "bug" as const,
		userMessage: "An external service isn't responding. Please try again later.",
		adminMessage: "Upstream service (GitHub, AI, payment) returned an error or timed out.",
	},
