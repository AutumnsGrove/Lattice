...
<div class="greenhouse-admin {className}">
	...
	<!-- Tenants Table -->
	<GreenhouseEnrollTable {tenants} {tenantNames} onToggle={handleToggle} onRemove={handleRemove} />
	...
	<div class="cultivate-section">
		...
		<!-- Feature Flags Table -->
		<CultivateFlagTable flags={featureFlags} onToggle={handleFlagToggle} {loadingFlagId} />
	</div>
</div>
