...
/**
 * Maturity lifecycle stage of a feature flag.
 *
 * - experimental: Early greenhouse-only testing
 * - beta: Broader testing, still greenhouse-only
 * - stable: Generally available, proven reliable
 * - graduated: Fully shipped, always evaluates true (kept for rollback)
 */
export type FlagMaturity = "experimental" | "beta" | "stable" | "graduated";
...
export interface FeatureFlag {
	...
	maturity: FlagMaturity; // Lifecycle stage of this flag
