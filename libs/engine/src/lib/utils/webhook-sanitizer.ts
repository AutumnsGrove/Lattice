 ...
 */
const META_WHITELIST = new Set(["event_name", "test_mode", "custom_data", "webhook_id"]);
...
/**
 * Sanitize a webhook payload by stripping PII.
 *
 ...
 *   .run();
 */
export function sanitizeWebhookPayload(payload: unknown): SanitizedWebhookPayload | null {
...
// =============================================================================
// Stripe Webhook Sanitization
// =============================================================================

/**
 * Safe fields to keep from Stripe webhook event objects.
 * Whitelist approach — anything not listed is stripped.
 */
...
/**
 * Sanitized Stripe webhook payload
 */
 ...
 *
 * Stripe events have the structure: { id, object, type, data: { object: {...} }, created, livemode }
 * This is different from Lemon Squeezy's { meta, data } format.
 *
