...
/**
 * Re-export PetalCategory from the canonical types location
 */
import type { PetalCategory } from "$lib/types/petal";
export type { PetalCategory } from "$lib/types/petal";
 ...
 * Account flag types
 */
export type PetalFlagType = "csam_detection" | "content_violations" | "abuse_pattern";

/**
 * Review status for flagged accounts
 */
export type PetalReviewStatus = "pending" | "reviewed" | "cleared" | "confirmed";
...
/**
 * Re-export PetalProviderConfig from the canonical types location
 */
export type { PetalProviderConfig } from "$lib/types/petal";
