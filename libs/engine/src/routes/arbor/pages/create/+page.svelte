...
<div class="max-w-screen-2xl mx-auto">
	<header
		class="flex justify-between items-start mb-6 max-md:flex-col max-md:items-stretch max-md:gap-4"
	>
		<div>
			<h1 class="m-0 mb-1 text-3xl text-foreground">Create New Page</h1>
			<p class="m-0 text-sm text-foreground-muted">Add a new page to your site</p>
		</div>
		...
		<GlassCard variant="default" class="details-section">
			<div class="details-content">
				...
				<div class="form-group">
					<label for="slug">
						URL Slug
						<span class="text-xs text-foreground-muted ml-2"> (Auto-generated from title) </span>
					</label>
					<div class="flex items-center gap-2 mb-2">
						<input type="checkbox" id="autoSlug" bind:checked={autoGenerateSlug} class="w-4 h-4" />
				...
				<div class="form-group">
					<div class="flex items-center gap-2 mb-2">
						<input type="checkbox" id="hasHero" bind:checked={hasHero} class="w-4 h-4" />
					...
					{#if hasHero}
						<div class="hero-fields">
							<div class="form-group">
								...
								<Input id="heroTitle" bind:value={heroTitle} placeholder="Welcome to..." />
							</div>

							<div class="form-group">
								<label for="heroSubtitle">Hero Subtitle</label>
								<Input id="heroSubtitle" bind:value={heroSubtitle} placeholder="A brief tagline" />
							</div>

							<div class="cta-fields">
								<div class="form-group">
									<label for="heroCtaText">CTA Button Text</label>
									<Input id="heroCtaText" bind:value={heroCtaText} placeholder="Learn More" />
								</div>

								<div class="form-group">
									<label for="heroCtaLink">CTA Button Link</label>
									<Input id="heroCtaLink" bind:value={heroCtaLink} placeholder="/blog" />
								</div>
							</div>
						</div>
					{/if}
