...
<div class="max-w-screen-xl">
	...
	<GlassCard variant="muted">
		<h3>About Pages</h3>
		<p>
			Pages are standalone content like About, Contact, or custom landing pages. Unlike blog posts,
			pages can appear in your site navigation and are designed for timeless content.
		</p>
		<p class="text-sm mt-2">
			<strong>Navigation limits:</strong> Your plan allows up to {navLimit} custom navigation pages. Home,
			Blog, and About are always included in navigation automatically.
		</p>
	</GlassCard>
</div>
