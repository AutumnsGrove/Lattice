...
<div class="webring-page">
	<header class="page-header">
		...
		<p class="subtitle">
			Join webrings and connect your site to the wider indie web. Add your ring memberships and
			...
			<div class="rings-list">
				{#each data.webrings as ring}
					<GlassCard class="ring-card">
						...
						<!-- Navigation Preview -->
						<div
							class="ring-nav-preview"
							class:badge-style={ring.badgeStyle === "badge"}
							class:compact-style={ring.badgeStyle === "compact"}
						>
							<a
								href={ring.prevUrl}
								target="_blank"
