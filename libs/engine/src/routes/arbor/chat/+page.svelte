<script lang="ts">
	...
	import { createConversationalChatController } from "$lib/ui/components/ui/glasschat/controller.svelte";
	import type { ChatRoleMap, ChatMessageData } from "$lib/ui/components/ui/glasschat/types";
	import { createChatConnection } from "$lib/ui/chat/connection.svelte";
	import type {
		ChatWSServerMessage,
		ConversationPreview,
		ChatFriendProfile,
	} from "$lib/ui/chat/types";
	import type {
		ChatConversationWithMeta,
		ChatMessageData as ChatMessageWireData,
	} from "$lib/server/services/chat.types.js";
	import { chatStore } from "$lib/ui/stores/chat.svelte";
