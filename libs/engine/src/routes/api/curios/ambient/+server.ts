...
import { isValidSoundSet, isValidVolume, isValidUrl, DEFAULT_VOLUME } from "$lib/curios/ambient";
...
export const POST: RequestHandler = async ({ request, platform, locals }) => {
	...
	const volume =
		typeof body.volume === "number" && isValidVolume(body.volume) ? body.volume : DEFAULT_VOLUME;
