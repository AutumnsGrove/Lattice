...
import type { ThemeColors, ValidationResult } from "../types.js";
 ...
 * Accepts any object with a `colors` property matching ThemeColors.
 */
export function validateThemeContrast(theme: { colors: ThemeColors }): ValidationResult {
