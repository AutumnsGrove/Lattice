...
<main class="min-h-screen flex flex-col transition-colors duration-1000 {isMidnight ? 'bg-gradient-to-b from-purple-950 via-slate-900 to-indigo-950' : isWinter ? 'bg-gradient-to-b from-slate-200 via-slate-100 to-slate-50 dark:from-surface-subtle dark:via-surface-elevated dark:to-card' : isAutumn ? 'bg-gradient-to-b from-orange-100 via-amber-50 to-yellow-50 dark:from-surface-subtle dark:via-surface-elevated dark:to-surface-alt' : isSpring ? 'bg-gradient-to-b from-pink-50 via-sky-50 to-lime-50 dark:from-surface-subtle dark:via-surface-elevated dark:to-surface-alt' : 'bg-gradient-to-b from-sky-100 via-sky-50 to-emerald-50 dark:from-surface-subtle dark:via-surface-elevated dark:to-surface-alt'}">
	...
	<article class="flex-1 relative overflow-hidden">
		...
		<div class="absolute bottom-6 right-6 z-grove-fab">
			<button
				...
				class="p-3 rounded-full backdrop-blur-md shadow-lg border hover:scale-110 transition-all duration-200 {isMidnight
					...
					: 'bg-white/85 dark:bg-card/35 border-white/30 dark:border-card/25 hover:bg-white/90 dark:hover:bg-card/45'}"
		...
		<div class="absolute inset-0 transition-colors duration-1000 {isMidnight ? 'bg-gradient-to-b from-purple-900/60 via-indigo-900/30 to-transparent' : isWinter ? 'bg-gradient-to-b from-slate-300/50 via-transparent to-transparent dark:from-surface-elevated/20' : isAutumn ? 'bg-gradient-to-b from-orange-200/50 via-transparent to-transparent dark:from-surface-elevated/20' : isSpring ? 'bg-gradient-to-b from-pink-200/40 via-sky-100/30 to-transparent dark:from-surface-elevated/20' : 'bg-gradient-to-b from-sky-200/50 via-transparent to-transparent dark:from-surface-elevated/20'}"></div>
