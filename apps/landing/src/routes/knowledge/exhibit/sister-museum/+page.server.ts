...
const GITHUB_RAW_URL = "https://raw.githubusercontent.com/AutumnsGrove/AutumnsGrove/main/MUSEUM.md";
 ...
 */
function extractHeaders(markdown: string): { level: number; text: string; id: string }[] {
