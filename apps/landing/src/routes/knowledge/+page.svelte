  ...
  <article class="flex-1 px-6 py-12">
    ...
    <div class="text-center mb-12">
      ...
      <p class="text-xl text-foreground-muted max-w-3xl mx-auto">
        Everything you need to know about Grove - from technical specifications to guides for <GroveTerm interactive term="wanderer">Wanderers</GroveTerm>
      </p>
    </div>
    ...
    <div class="max-w-2xl mx-auto mb-12">
      <form onsubmit={handleSearch} class="relative">
        <label for="kb-search" class="sr-only">Search documentation</label>
        <input
          id="kb-search"
          type="text"
        ...
        <div class="absolute inset-y-0 left-0 flex items-center pl-4">
          <svg aria-hidden="true" class="w-5 h-5 text-foreground-subtle" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="mt-12 text-center">
      ...
      <div class="flex flex-wrap justify-center gap-4">
        <a href="/knowledge/marketing/grove-at-a-glance" class="px-4 py-2 bg-success-bg text-success-foreground rounded-lg hover:bg-success-bg/80 transition-colors">
          Grove at a Glance
        </a>
        <a href="/knowledge/help/what-is-grove" class="px-4 py-2 bg-info-bg text-info-foreground rounded-lg hover:bg-info-bg/80 transition-colors">
          What is Grove?
        </a>
        ...
        <a href="/contact" class="inline-flex items-center gap-2 px-4 py-2 bg-success-bg text-success-foreground rounded-lg hover:bg-success-bg/80 transition-colors">
          <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
