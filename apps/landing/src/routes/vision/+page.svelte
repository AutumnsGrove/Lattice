		...
		<div class="max-w-3xl mx-auto">
			...
			<div class="prose prose-bark max-w-none">
				<p class="text-lg text-foreground-muted font-sans leading-relaxed mb-8">
					The internet used to be a place of personal expression. Geocities. Angelfire. Blogs with
					personality. Somewhere along the way, we traded that for algorithms, engagement metrics,
					and platforms that own our words.
				</p>

				<p class="text-lg text-foreground-muted font-sans leading-relaxed mb-12">
					<strong class="text-accent-muted">Grove.place is a return to something simpler.</strong> A place
					where people can plant their thoughts and watch them grow. No ads. No tracking. No algorithmic
					feeds deciding who sees what. Just writers and readers, meeting in a digital grove.
				</p>
				...
				<section id="the-vision" class="mb-12 scroll-mt-28">
					...
					<p class="text-foreground-muted font-sans leading-relaxed mt-4">
						The platform should feel like walking through a peaceful forest at golden hour. Calm.
						Intentional. A refuge from the noise of social media.
					</p>
				</section>
				...
				<section id="core-values" class="mb-12 scroll-mt-28">
					...
					<div class="grid gap-6">
						<GlassCard
							...
							iconClass="text-accent-subtle"
						>
							<p class="text-foreground-muted font-sans leading-relaxed mb-3">
								Everyone deserves a voice online. Pricing should never be the barrier that stops
								someone from sharing their story. The basic tier exists so that anyone who wants to
								write can afford to write.
							</p>
							<p class="text-foreground-muted font-sans leading-relaxed">
								<strong class="text-foreground">Reading is always free.</strong> Every Grove blog is publicly
								accessible — no login, no paywall. You pay to write, not to read.
							</p>
						</GlassCard>

						<GlassCard title="Ownership" icon={OwnershipIcon} iconClass="text-accent-subtle">
							<p class="text-foreground-muted font-sans leading-relaxed">
								Your words are yours. Your data is yours. You can export everything, anytime. If you
								leave, you take your roots with you.
							</p>
						</GlassCard>

						<GlassCard title="Simplicity" icon={SimplicityIcon} iconClass="text-accent-subtle">
							<p class="text-foreground-muted font-sans leading-relaxed">
								No feature bloat. No endless settings. Write in Markdown. Upload images. Publish.
								That's it. The technology should disappear into the background.
							</p>
						</GlassCard>
						...
						>
							<p class="text-foreground-muted font-sans leading-relaxed">
								Intentionally queer-friendly. Welcoming to all. No engagement metrics breeding
								outrage. No viral mechanics rewarding the loudest voice. Just people, sharing what
								matters to them.
							</p>
						</GlassCard>

						<GlassCard title="AI Sanctuary" icon={AiSanctuaryIcon} iconClass="text-accent-subtle">
							<p class="text-foreground-muted font-sans leading-relaxed">
								Your words are not training data. Grove blocks every AI crawler, every scraper,
								every "search agent" that wants to harvest content for machine learning.
								<a
									href="https://developers.cloudflare.com/bots/additional-configurations/block-ai-bots/"
									target="_blank"
									rel="noopener noreferrer"
									class="text-accent-muted underline decoration-1 underline-offset-2 hover:text-accent"
									>Cloudflare stands at the gate</a
								>, and our corner of the web becomes a black hole to external AI. Learn more about
								<a
									href="https://grove.place/knowledge/help/how-grove-protects-your-content"
									target="_blank"
									rel="noopener noreferrer"
									class="text-accent-muted underline decoration-1 underline-offset-2 hover:text-accent"
									>how Grove protects your content from AI scraping</a
								>.
							</p>
							<p class="text-foreground-muted font-sans leading-relaxed mt-3">
								We do use AI internally for content moderation, but intentionally: with <a
									href="/knowledge/help/what-is-zdr"
									class="text-accent-muted underline decoration-1 underline-offset-2 hover:text-accent"
									>zero data retention</a
								>, with privacy-first providers, with no training on your words. There's a
								difference between using a tool carefully and feeding a machine indiscriminately.
							</p>
					...
					>
						<SolarpunkIcon
							class="w-5 h-5 text-warning-foreground dark:text-warning-foreground shrink-0"
						/>
						<span
							class="text-sm text-foreground-muted group-hover:text-foreground transition-colors"
						>
							These values reflect <strong
								class="text-warning-foreground dark:text-warning-foreground">solarpunk</strong
							>
							thinking.
							<span class="text-foreground-subtle group-hover:text-foreground-muted"
								>Learn what that means →</span
							>
						</span>
					</a>
				</section>
				...
				<section id="on-community-meadow" class="mb-12 scroll-mt-28">
					...
					<div class="bg-accent border border-accent rounded-xl p-6 mb-6">
						...
						<p class="text-foreground-muted font-sans leading-relaxed mt-4">
							Beneath the surface, roots intermingle. Trees share nutrients through mycorrhizal
							networks — the "wood wide web" that connects an entire forest into a single living
							organism. The oldest trees nurture the saplings. The seasonal cycles nourish new
							growth.
						</p>
					</div>

					<p class="text-foreground-muted font-sans leading-relaxed mb-6">
						<strong class="text-accent-muted">Meadow is the roots.</strong> It's optional. Your blog exists
						independently, complete on its own. But if you choose, you can connect — follow friends, see
						their posts in a simple chronological feed, leave reactions that only they can see.
					</p>
					...
					<ul class="space-y-3 text-foreground-muted font-sans">
						<li class="flex items-start gap-3">
							...
							<span
								><strong>No public metrics.</strong> Follower counts aren't displayed. Like counts don't
								create hierarchies. Your worth isn't measured by engagement.</span
							>
						</li>
						<li class="flex items-start gap-3">
							<NoAlgorithmIcon class="w-4 h-4 text-accent-subtle mt-1 shrink-0" />
							<span
								><strong>No algorithm.</strong> The feed is chronological. Your friends' posts appear
								in order. Nothing is hidden or boosted based on "engagement potential."</span
							>
						</li>
						<li class="flex items-start gap-3">
							<PrivateEncouragementIcon class="w-4 h-4 text-accent-subtle mt-1 shrink-0" />
							<span
								><strong>Private encouragement.</strong> Reactions and comments are visible to the author
								only. Feedback becomes encouragement, not performance.</span
							>
						</li>
						<li class="flex items-start gap-3">
							<FullControlIcon class="w-4 h-4 text-accent-subtle mt-1 shrink-0" />
							<span
								><strong>Full control.</strong> Want to see friends' posts but disable interactions on
								yours? Fine. Want to hide from discovery entirely? Fine. Every setting is yours to configure.</span
							>
						</li>
						<li class="flex items-start gap-3">
							<OpenStandardsIcon class="w-4 h-4 text-accent-subtle mt-1 shrink-0" />
							<span
								><strong>Built on open standards.</strong> Your blog isn't locked into Grove. The connections
								between blogs use the same portable technology that powers podcasts and news readers.
								If you ever leave, your followers can still follow you wherever you go.</span
							>
						</li>
					</ul>
				</section>
				...
				<section id="where-this-comes-from" class="mb-12 scroll-mt-28">
					...
					<p class="text-foreground-muted font-sans leading-relaxed mb-4">
						Before Grove existed, I had a backyard with a hammock and a garden. A front porch where
						I watched sunrises. Birds I knew by song. Friends who came over just to exist together.
						My days had <em>texture</em>.
					</p>
					<p class="text-foreground-muted font-sans leading-relaxed mb-4">
						Then I lost it all. And in the numbness that followed, I started building a place where
						people could plant their own little sanctuaries, tend their own corners of the internet,
						and find some of that texture again.
					</p>
					<GlassCard variant="accent" class="mb-6">
						<p class="text-foreground-muted font-sans leading-relaxed">
							Grove is a refuge because I needed one. <strong class="text-accent-muted"
								>I'm building a grove for people who lost their groves.</strong
							>
						</p>
					</GlassCard>
					<a
				...
				<section class="text-center py-8 border-t border-default">
					...
					<p class="text-accent-muted font-serif text-lg">A forest of voices. A place to be.</p>
				</section>
		...
		{#each tocHeaders as header}
			...
			<div class="relative group">
				...
				>
					{#if SectionIcon}
						<SectionIcon
							class="w-5 h-5 text-accent dark:text-accent-muted group-hover:scale-110 transition-transform"
						/>
					{/if}
				</a>
				...
				>
					<div
						class="px-3 py-1.5 rounded-lg bg-white dark:bg-cream-100 shadow-md border border-accent/20 dark:border-accent/10 text-sm font-medium text-foreground whitespace-nowrap"
					>
						{header.text}
					</div>
				</div>
