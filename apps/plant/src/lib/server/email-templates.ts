...
// Payment email templates (getPaymentFailedEmail, getPaymentReceivedEmail)
// have been moved to billing-api (grove-billing-api worker) which sends
// payment emails via Zephyr. See services/billing-api/
