...
import type { ErrorCategory as _ErrorCategory, GroveErrorDef } from "@autumnsgrove/lattice/errors";
...
export const PLANT_ERRORS = {
	...
	ONBOARDING_QUERY_FAILED: {
		...
		adminMessage: "SELECT from user_onboarding failed. Table may not exist or query error.",
	},
	...
	ONBOARDING_UPDATE_FAILED: {
		code: "PLANT-042",
		category: "bug" as const,
		userMessage: "Something went wrong updating your account. Please try again.",
