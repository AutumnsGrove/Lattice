<script lang="ts">
	...
	import { blazeIcons, navIcons, actionIcons } from "@autumnsgrove/prism/icons";
	import {
	...
	} from "@autumnsgrove/lattice/curios/nowplaying";
	...
	const currentTrack = $derived(data.history && data.history.length > 0 ? data.history[0] : null);
</script>
	...
	<GlassCard class="manual-card">
		...
		>
			<div class="form-grid">
				...
				<div class="input-group">
					<label class="input-label" for="album"
						>Album <span class="optional">(optional)</span></label
					>
					<input
						id="album"
						type="text"
				...
				<div class="input-group">
					<label class="input-label" for="albumArtUrl"
						>Album Art URL <span class="optional">(optional)</span></label
					>
					<input
						id="albumArtUrl"
						type="url"
			...
			<div class="form-section">
				...
				<div class="style-grid">
					{#each PROVIDER_OPTIONS as option}
						<label class="style-option" class:selected={provider === option.value}>
							<input type="radio" name="provider" value={option.value} bind:group={provider} />
			...
			<div class="form-section">
				...
				<div class="style-grid">
					{#each DISPLAY_STYLE_OPTIONS as option}
						<label class="style-option" class:selected={displayStyle === option.value}>
							<input
								type="radio"
								name="displayStyle"
								value={option.value}
