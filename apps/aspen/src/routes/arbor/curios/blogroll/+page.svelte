...
<div class="blogroll-page">
	<header class="page-header">
		...
		<p class="subtitle">
			The blogs you love, the voices you return to. Share your reading list with the world.
		</p>
	</header>
							...
							<div class="blog-info">
								...
								<div>
									...
									{#if blog.lastPostTitle}
										<p class="latest-post">
											Latest: <a href={blog.lastPostUrl} target="_blank" rel="noopener noreferrer"
												>{blog.lastPostTitle}</a
											>
										</p>
									{/if}
								</div>
