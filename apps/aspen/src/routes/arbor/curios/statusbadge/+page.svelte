<script lang="ts">
	...
	const selectedDefinition = $derived(BADGE_DEFINITIONS.find((d) => d.type === selectedBadgeType));
</script>
...
<div class="statusbadge-admin">
	<header class="page-header">
		...
		<p class="subtitle">
			Small, expressive badges that signal the state of your site. A hand-written sign on the shop
			door.
		</p>
	</header>
						...
						<div class="badge-info">
							...
							<div class="badge-details">
								...
								<span class="badge-meta">
									{BADGE_POSITION_OPTIONS.find((p) => p.value === badge.position)?.label ??
										badge.position}
									{#if badge.animated}
										&middot; Animated
									{/if}
				...
				<div class="form-section">
					...
					<div class="badge-type-grid">
						{#each availableBadgeTypes as def}
							<label class="badge-type-option" class:selected={selectedBadgeType === def.type}>
								<input
									type="radio"
									name="badgeType"
									value={def.type}
				...
				{#if selectedBadgeType}
					...
					<div class="form-section">
						...
						<div class="position-grid">
							{#each BADGE_POSITION_OPTIONS as option}
								<label class="position-option" class:selected={selectedPosition === option.value}>
									<input
										type="radio"
										name="position"
										value={option.value}
					...
					<div class="form-section">
						...
						<div class="input-group">
							<label class="input-label" for="customText"> Override the default badge label </label>
							<input
								id="customText"
								type="text"
								name="customText"
					...
					<div class="form-actions">
						...
						<GlassButton
							type="submit"
							variant="accent"
							disabled={isSubmitting || !selectedBadgeType}
						>
