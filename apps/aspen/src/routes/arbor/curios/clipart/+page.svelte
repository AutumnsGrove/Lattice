...
<div class="clipart-page">
	<header class="page-header">
		...
		<p class="subtitle">
			Decorative overlays you can place on any page — borders, critters, sparkles, and more.
		</p>
	</header>
						...
						<div class="placement-header">
							<div class="placement-info">
								...
								<span class="placement-meta">
									{placement.pagePath} &middot; ({placement.xPosition}%, {placement.yPosition}%)
									&middot;
									{placement.scale}x &middot; {placement.rotation}&deg; &middot; z{placement.zIndex}
								</span>
							</div>
