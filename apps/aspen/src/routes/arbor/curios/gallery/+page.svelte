...
<div class="gallery-config">
	<header class="page-header">
		...
		<div class="header-content">
			...
			<p class="subtitle">
				A beautiful image gallery powered by Amber storage. Display your photos with filtering,
				tags, and lightbox viewing.
			</p>
		</div>
	</header>
	...
	>
		...
		<GlassCard class="config-section">
			...
			<div class="toggle-row">
				...
				<p class="field-help">When enabled, the gallery page will be publicly accessible.</p>
			</div>
			...
			<div class="field-group">
				...
				<input
					...
					class="field-input"
				/>
				<p class="field-help">The title displayed at the top of your gallery page.</p>
			</div>
			...
			<div class="field-group">
				...
				<textarea
					...
					rows="2"
				></textarea>
				<p class="field-help">Optional subtitle shown below the gallery title.</p>
			</div>
		</GlassCard>
		...
		<GlassCard class="config-section">
			...
			<div class="sync-section-top">
				...
				<p class="field-help">
					Import new images you've uploaded to your Amber storage into the gallery. This scans for
					new files and adds them to your gallery database.
				</p>
			</div>
			...
			<details class="advanced-section">
				...
				<div class="field-group">
					<label for="cdnBaseUrl" class="field-label"> CDN Base URL </label>
					<input
						type="text"
						id="cdnBaseUrl"
						name="cdnBaseUrl"
					...
					<p class="field-help field-warning">
						⚠️ Using a CDN you don't control will break your images. We can't back up images stored
						elsewhere, so you're responsible for that storage.
					</p>
				</div>
				...
				<div class="field-group">
					...
					/>
					<p class="field-help">
						The Amber storage bucket for your images. Leave this alone unless you have a specific
						reason to change it.
					</p>
				</div>
			</details>
		...
		<GlassCard class="config-section">
			...
			<div class="field-row">
				<div class="field-group">
					...
					<select id="gridStyle" name="gridStyle" bind:value={gridStyle} class="field-select">
				...
				<div class="field-group">
					...
					<select id="sortOrder" name="sortOrder" bind:value={sortOrder} class="field-select">
		...
		<GlassCard class="config-section">
			...
			<div class="checkbox-grid">
				...
				<label class="checkbox-option">
					<input type="checkbox" name="showDates" value="true" bind:checked={showDates} />
					<span class="checkbox-label">Show dates</span>
				</label>

				<label class="checkbox-option">
					<input type="checkbox" name="showTags" value="true" bind:checked={showTags} />
					<span class="checkbox-label">Show tags</span>
				</label>

				<label class="checkbox-option">
					<input type="checkbox" name="enableLightbox" value="true" bind:checked={enableLightbox} />
					<span class="checkbox-label">Enable lightbox</span>
				</label>

				<label class="checkbox-option">
					<input type="checkbox" name="enableSearch" value="true" bind:checked={enableSearch} />
					<span class="checkbox-label">Enable search</span>
				</label>

				<label class="checkbox-option">
					<input type="checkbox" name="enableFilters" value="true" bind:checked={enableFilters} />
		...
		<GlassCard class="config-section">
			...
			<div class="field-group">
				...
				<textarea
					...
					rows="6"
				></textarea>
				<p class="field-help">Add custom CSS to style your gallery. Use with caution.</p>
			</div>
		</GlassCard>
