...
import { isValidBadgePosition, sanitizeCustomText } from "@autumnsgrove/lattice/curios/statusbadge";
...
export const PATCH: RequestHandler = async ({ params, request, platform, locals }) => {
	...
	try {
		await db
			.prepare(`UPDATE status_badges SET ${updates.join(", ")} WHERE id = ? AND tenant_id = ?`)
