...
<div class="space-y-8">
	...
	<div class="flex gap-4">
		...
		<GlassButton variant="ghost" href="/arbor/history">
			View All History
		</GlassButton>
	</div>
		...
		{:else}
			<div class="divide-y glass-divide">
				{#each data.jobs.slice(0, 5) as job}
					<a href="/arbor/history/{job.id}" class="block p-4 hover:bg-white/40 dark:hover:bg-neutral-800/40 transition-colors">
