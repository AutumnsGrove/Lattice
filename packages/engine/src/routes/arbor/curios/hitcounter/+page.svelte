  ...
  <GlassCard class="preview-card">
    ...
    <div class="counter-preview style-{style}">
      ...
      {#if showSinceDate && data.config?.startedAt}
        <span class="since-date since-date--{sinceDateStyle}">{formatSinceDate(data.config.startedAt)}</span>
      {/if}
    </div>
  </GlassCard>
    ...
    >
      ...
      <div class="form-section">
        ...
        <div class="input-group">
          <label class="input-label" for="labelPreset">
        ...
        {#if labelPreset === "__custom__"}
          <div class="input-group">
            <label class="input-label" for="customLabel">
              Custom label text
            </label>
            <input
              id="customLabel"
