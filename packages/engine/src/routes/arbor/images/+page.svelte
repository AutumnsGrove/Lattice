  ...
  <section class="upload-section">
    ...
    <GlassCard variant="default" class="options-panel">
      ...
      <button class="advanced-toggle" onclick={() => showAdvanced = !showAdvanced}>
        <svg class="chevron" class:open={showAdvanced} viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
          <path d="M6 9l6 6 6-6"/>
        </svg>
        Advanced Options
      </button>
      ...
      {#if showAdvanced}
        <div class="options-advanced">
          ...
          <div class="options-info">
            <p>Images auto-organized to <code>photos/{new Date().getFullYear()}/{String(new Date().getMonth()+1).padStart(2,'0')}/{String(new Date().getDate()).padStart(2,'0')}/</code></p>
