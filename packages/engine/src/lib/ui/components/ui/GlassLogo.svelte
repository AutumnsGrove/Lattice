<script lang="ts">
	...
	// Glow intensity pulses with breath
	...
	// Combined foliage for highlight overlay
	const foliagePath = `${tier1DarkPath} ${tier1LightPath} ${tier2DarkPath} ${tier2LightPath} ${tier3DarkPath} ${tier3LightPath}`;
</script>
