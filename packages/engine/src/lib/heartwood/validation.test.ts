  ...
  describe("type narrowing", () => {
    it("should narrow type after validation", () => {
      ...
      if (isValidCredential(body)) {
        ...
        expect(body.response.attestationObject).toBe(
...
describe("getRequiredEnv", () => {
  describe("with environment variables", () => {
    it("should return value when present", () => {
      ...
      expect(getRequiredEnv(env, "AUTH_BASE_URL")).toBe(
  ...
  describe("with fallback", () => {
    it("should use fallback when env is undefined", () => {
      expect(
        getRequiredEnv(undefined, "AUTH_BASE_URL", "https://fallback.com"),
  ...
  describe("error messages", () => {
    it("should include variable name in error", () => {
      expect(() => getRequiredEnv(undefined, "MY_CUSTOM_VAR")).toThrow(
        "MY_CUSTOM_VAR",
      );
    });
  });
