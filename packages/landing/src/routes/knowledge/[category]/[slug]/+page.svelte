		...
		{#if doc}
			...
			<div class="max-w-7xl mx-auto flex gap-8">
				...
				<div class="flex-1 min-w-0 max-w-4xl">
					<!-- Breadcrumb -->
					<nav
						class="flex items-center space-x-2 text-sm text-foreground-muted mb-8"
						aria-label="Breadcrumb"
					>
						<a href="/knowledge" class="hover:text-foreground transition-colors">Knowledge Base</a>
						<span aria-hidden="true">/</span>
						<a href="/knowledge/{category}" class="hover:text-foreground transition-colors"
							>{categoryTitle}</a
						>
						<span aria-hidden="true">/</span>
					...
					<header class="content-header">
						<div class="flex items-center gap-3 mb-4 flex-wrap">
							...
							<span
								class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium {colors.badgeBg} {colors.badgeBgDark} {colors.badgeText} {colors.badgeTextDark}"
							>
								{#if category === "specs"}
									Technical Spec
		...
		{:else}
			...
			<div class="text-center py-12 max-w-4xl mx-auto">
				...
				<div class="flex gap-4 justify-center flex-wrap">
					<a
						href="/knowledge"
						class="px-4 py-2 bg-foreground text-background rounded-lg hover:bg-foreground-muted transition-colors"
					>
						Knowledge Base Home
					</a>
					<a
						href="/knowledge/specs"
						class="px-4 py-2 {kbCategoryColors.specs.badgeBg} {kbCategoryColors.specs
							.badgeBgDark} {kbCategoryColors.specs.badgeText} {kbCategoryColors.specs
							.badgeTextDark} rounded-lg hover:opacity-80 transition-colors"
					>
						Browse Specs
					</a>
					<a
						href="/knowledge/help"
						class="px-4 py-2 {kbCategoryColors.help.badgeBg} {kbCategoryColors.help
							.badgeBgDark} {kbCategoryColors.help.badgeText} {kbCategoryColors.help
							.badgeTextDark} rounded-lg hover:opacity-80 transition-colors"
					>
						Browse Help
					</a>
