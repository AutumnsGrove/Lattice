	...
	<div class="flex-1 px-6 py-12">
			...
			<div class="max-w-7xl mx-auto flex gap-8">
				...
				<div class="flex-1 min-w-0 max-w-4xl">
					...
					>
						...
						<a href="/knowledge/exhibit" class="hover:text-foreground transition-colors"
							>Art Exhibit</a
						>
						<span aria-hidden="true">/</span>
		...
		{:else}
			...
			<div class="text-center py-12 max-w-4xl mx-auto">
				...
				<a
					href="/knowledge/exhibit"
					class="px-4 py-2 {colors.buttonBg} text-white rounded-lg {colors.buttonHover} transition-colors"
				>
